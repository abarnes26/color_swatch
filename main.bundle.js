...
var _color_calls = __webpack_require__(7);

var _color_calls2 = _interopRequireDefault(_color_calls);
...
var colorList = __webpack_require__(0);
...
var parseAndPostColors = function parseAndPostColors(text) {
  text.split(/[ ,.]+/).forEach(function (word) {
    if (colorList['' + word.toLowerCase()]) {
      var postBody = { color: { value: word } };
      postColors(postBody);
    }
  });
};

var postColors = function postColors(body) {
